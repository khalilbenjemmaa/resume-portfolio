...
function Terminal({ currentData, setLanguage, exitTerminal }) {
    ...
    const handleCommand = (command) => {
        ...
        if(cmd === 'b3r')  output.content = ' !!!!!!!!!!!! Mahdi Ba3rouraaaaaa33333333333 !!!!!!! \n !!!!!!!!!!!! Mahdi Ba3rouraaaaaa33333333333 !!!!!!!'
